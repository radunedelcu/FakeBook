            ...
            <div class="card card-profile shadow">
              <div class="row justify-content-center">
                <div class="col-lg-3 order-lg-2">
                  <div class="card-profile-image">
                    <a v-if="profile.profile.profilePicture">
                      <ExpandableImage v-bind:src="'https://localhost:7026/' + profile.profile.profilePicture"
                        class="rounded-circle"/>
                    </a>
                  <a v-else>
                  <img src="https://i.imgur.com/WxNkK7J.png" class="rounded-circle">
                  </a>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body pt-0 pt-md-4">
                ...
                <div class="text-center">
                  <h3>
                    <span class="font-weight-light">{{ profile.profile.name }}</span>
                  </h3>
...
export default {
  ...
  computed: {
    ...
    profile() {
      console.log("asta" + this.$store.state.profile);
...
.expandable-image .rounded-circle {
  object-fit: cover;
  border-radius: 0% !important;
}
