...
public class AuthenticationController : ControllerBase
{
    ...
    [HttpPost("register")]
    public async Task<IActionResult> Register([FromForm] RequestRegisterModel requestRegisterModel)
    {
        ...
        _authenticationCommand.UploadCoverImage(requestRegisterModel.CoverImage);
        _authenticationCommand.UploadProfilePicture(requestRegisterModel.ProfilePicture);
